...
Main.page-exchange
  Row.search(:gutter="15")
    ...
    Col(span="4")
      Select(v-model="searchForm.symbolId" filterable)
  ...
  currentOrder(:data="listData", :loading="loading" v-if="type==1" @cancelOrder="loadData")
...
<script>
  ...
  export default {
    ...
    methods: {
      change(type) {
        this.$router.replace('/exchange/orders/' + type);
        this.search();
      },
      search() {
