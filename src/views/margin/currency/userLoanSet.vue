...
<template lang="pug">
	.page-exchange
		...
		Modal(v-model="showModal", :title="showType === 'add' ? $lang('新增用户币种借贷配置') : $lang('修改用户币种借贷配置')" width="800")
  ...
  export default {
    ...
    methods: {
      submit () {
        this.loading = true;
        this.$axios
          .post("/api/v1/margin/set/token_config/user_loan_limit", {
            ...this.formData,
      ...
      loadData () {
        ...
        this.$axios
          .get("/api/v1/margin/get/token_config/user_loan_limit", {
            params: {
              ...this.searchForm,
            },
          })
